(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      "home.description": "Aqui, o calendário vira uma experiência visual: cada um dos doze meses ganha sua própria paleta, inspirada nas campanhas de conscientização, nas estações e nas datas que marcam aquele período no Brasil. Escolha um mês abaixo e descubra mais!",
    ...
    en: {
      ...
      "home.description": "Here, the calendar becomes a visual experience: each of the twelve months receives its own palette, inspired by awareness campaigns, the seasons and the dates that mark that period in Brazil. Choose a month below and discover more!",
    ...
    fr: {
      ...
      "home.description": "Ici, le calendrier devient une expérience visuelle : chacun des douze mois reçoit sa propre palette, inspirée des campagnes de sensibilisation, des saisons et des dates qui marquent cette période au Brésil. Choisissez un mois ci-dessous et découvrez-en davantage !",
    ...
    es: {
      ...
      "home.description": "Aquí, el calendario se convierte en una experiencia visual: cada uno de los doce meses recibe su propia paleta, inspirada en las campañas de concienciación, las estaciones y las fechas que marcan ese período en Brasil. ¡Elige un mes y descubre más!",
